 ...
 */
const PROGRAM_SO_PATH = path.join(PROGRAM_PATH, 'snft.so');

/**
 * Path to the keypair of the deployed program.
 * This file is created when running `solana program deploy dist/program/helloworld.so`
 */
const PROGRAM_KEYPAIR_PATH = path.join(PROGRAM_PATH, 'ufit-keypair.json');
...
export async function buildNFT(): Promise<void> {
